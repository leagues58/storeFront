    ...
    public class MockProductRepository : IProductRepository
    {
        ...
        private void InitializeProducts()
        {
            products = new List<Product>
            {
                ...
                new Product {Id = 4, Name = "Headphones", Price = 300.00M, ShortDescription = "Put them over your ears to hear things that aren't happening around you.", LongDescription = "This is the long description for some headphones.  I refuse to spend too much time mocking this out because I already know it won't be used for very long.", ThumbnailUrl = "/images/car.jpg"}
            };
        }
